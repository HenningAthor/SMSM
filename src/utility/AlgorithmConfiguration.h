#ifndef SMSM_ALGORITHMCONFIGURATION_H
#define SMSM_ALGORITHMCONFIGURATION_H
...
public:
    ...
    size_t verbose_level = 0; // verbose level
    ...
    size_t determine_UB2D_max_l(size_t t_n, size_t t_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var_max) * UB2D_l_y);
        if (UB2D_l_func == 1) {
    ...
    size_t determine_UB2D_l(size_t t_n, size_t t_k, size_t t_r_n, size_t t_r_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var) * UB2D_l_y);
        if (UB2D_l_func == 1) {
    ...
    size_t determine_PBF_max_n(size_t t_n, size_t t_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var_max) * PBF_n_y);
        if (PBF_n_func == 1) {
    ...
    size_t determine_PBF_max_l(size_t t_n, size_t t_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var_max) * PBF_l_y);
        if (PBF_l_func == 1) {
    ...
    size_t determine_PBF_n(size_t t_n, size_t t_k, size_t t_r_n, size_t t_r_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var) * PBF_n_y);
        if (PBF_n_func == 1) {
    ...
    size_t determine_PBF_l(size_t t_n, size_t t_k, size_t t_r_n, size_t t_r_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var) * PBF_l_y);
        if (PBF_l_func == 1) {
    ...
    size_t determine_REC_max_l(size_t t_n, size_t t_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var_max) * REC_l_y);
        if (REC_l_func == 1) {
    ...
    size_t determine_REC_l(size_t t_n, size_t t_k, size_t t_r_n, size_t t_r_k) const {
        ...
        size_t res = (size_t) (sqrt((double) var) * REC_l_y);
        if (REC_l_func == 1) {
    ...
    std::string to_JSON() {
        ...
        content += "\"score-threshold\" : " + ::to_JSON_value(score_threshold) + ",\n";
        ...
        content += "\"verbose-level\" : " + to_JSON_value(verbose_level) + ",\n";
    ...
    void parse_UB2D(std::vector<std::string> &ub2d_option, bool verbose) {
        ...
        err_msg += "<<\nUse:\n\t--UB2D Disabled\n\t--UB2D {Sqrt[x]*y, x*y, y} {max_y} {Greedy, Matching, BForce, Dynamic} {A, B, AB} {0, 1} {0, 1} {lazy_start} {lazy_add} {low_depth_percentage} {high_depth_percentage} {sub_bound_percentage} for x in {n, k, r_n, r_k},y >= 0.0 (float), max_y >= 0 (int), 0.0 <= lazy_start <= 1.0 (float), 0.0 <= lazy_add <= 1.0 (float), 0.0 <= low_depth_percentage <= high_depth_percentage <= 1.0 (float), 0.0 <= sub_bound_percentage <= 1.0 (float).\n";
    ...
    void parse_PBF(std::vector<std::string> &pbf_option, bool verbose) {
        ...
        err_msg += "<<\nEither use:\n\t--PBF Disabled\n\t--PBF {Sqrt[x_1]*y_1, x_1*y_1, y_1} {max_n} {Sqrt[x_2]*y_2, x_2*y_2, y_2} {max_l} {BForce, Dynamic} {0, 1} {0, 1} {lazy_start} {lazy_add} {low_depth_percentage} {high_depth_percentage} {sub_bound_percentage} for x_1, x_2 in {n, k, r_n, r_k}, y_1, y_2 >= 0.0 (float), max_n >= 0 (int), max_l >= 0 (int), 0.0 <= lazy_start <= 1.0 (float), 0.0 <= lazy_add <= 1.0 (float), 0.0 <= low_depth_percentage <= high_depth_percentage <= 1.0 (float), 0.0 <= sub_bound_percentage <= 1.0 (float) .\n";
    ...
    void parse_REC(std::vector<std::string> &rec_option, bool verbose) {
        ...
        err_msg += "<<\nEither use:\n\t--REC Disabled\n\t--REC {Sqrt[x]*y, x*y, y} {max_l} {0, 1} {0, 1} {lazy_start} {lazy_add} {low_depth_percentage} {high_depth_percentage} {sub_bound_percentage} for x_1, x_2 in {n, k, r_n, r_k}, y_1, y_2 >= 0.0 (float), max_n >= 0 (int), max_l >= 0 (int), 0.0 <= lazy_start <= 1.0 (float), 0.0 <= lazy_add <= 1.0 (float), 0.0 <= low_depth_percentage <= high_depth_percentage <= 1.0 (float), 0.0 <= sub_bound_percentage <= 1.0 (float) .\n";
...
#endif //SMSM_ALGORITHMCONFIGURATION_H
