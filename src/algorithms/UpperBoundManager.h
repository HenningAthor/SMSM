#ifndef SMSM_UPPERBOUNDMANAGER_H
#define SMSM_UPPERBOUNDMANAGER_H
...
public:
    ...
    /**
     * Checks if the manager has a solution for r.
     *
    ...
    inline void print_r() {
        p1_sets.print();
        print(p1_si, p1_si.size());
        print(p2_c, p2_c.size());
        print(p2_si, p2_si.size());
        std::cout << sum_p1 << " " << sum_p2 << std::endl;
    }

    inline void print_r1() {
        p1_sets_r1.print();
        print(p1_si_r1, p1_si_r1.size());
        print(p2_c_r1, p2_c_r1.size());
        print(p2_si_r1, p2_si_r1.size());
        std::cout << sum_p1_r1 << " " << sum_p2_r1 << std::endl;
    }
};


#endif //SMSM_UPPERBOUNDMANAGER_H
